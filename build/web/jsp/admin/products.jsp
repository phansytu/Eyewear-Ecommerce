...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold fs-4" href="#"><i class="fas fa-glasses me-2"></i>Admin Dashboard</a>
                                    ...
                                    <c:forEach var="product" items="${products}">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted">${product.brand} | ${product.categoryName}</small>
                                            </td>
                                            <td>
            ...
            <div class="modal-content shadow-lg">
                <form method="POST" enctype="multipart/form-data">
                    <div class="modal-header bg-dark text-white">
                        <h5 class="modal-title"><i class="fas fa-box-open me-2"></i>Thông tin sản phẩm</h5>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="stock" value="${editProduct.stock}" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Mô tả chi tiết</label>
                                    <textarea name="description" class="form-control" rows="4">${editProduct.description}</textarea>
                                </div>
                            </div>
                            
                            <div class="col-md-4 bg-light p-3 rounded shadow-sm">
                                <label class="form-label fw-bold">Ảnh sản phẩm</label>
                                <div class="image-preview border rounded bg-white d-flex align-items-center justify-content-center mb-3" style="height: 250px;">
                                    <c:choose>
                                        <c:when test="${not empty editProduct.image}">
                                            <img src="${root}${editProduct.image}" id="previewImg">
                                        </c:when>
                                        <c:otherwise>
                                ...
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" name="isFeatured" ${editProduct.isFeatured ? 'checked' : ''}>
                                    <label class="form-check-label">Sản phẩm nổi bật</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="uvProtection" ${editProduct.uvProtection ? 'checked' : ''}>
                                    <label class="form-check-label">Chống tia UV</label>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.quick-edit').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                // Logic AJAX để lấy dữ liệu sản phẩm đổ vào modal sẽ nằm ở đây
